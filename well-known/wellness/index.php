    ...
    <div class="card mb-4">
      ...
      <div class="card-body px-5">
          ...
          <div class = "row mb-2">
              ...
              <div class="col-8">
                <input type="text" name="nic" id="nic" class="form-control" placeholder="NIC/Passport Number" required>
              </div>
          </div>
          ...
          <div class = "row mb-2">
              ...
              <div class="col-8">
                <input type="tel" name="txtMobile" id="txtMobile" class="form-control" placeholder="Mobile Number" required>
              </div>
          </div>
          ...
          <div class = "row mb-2">
              ...
              <div class="col-8">
                <input type="tel" name="fixedcon" id="fixedcon" class="form-control" placeholder="Residence Contact No " required>
              </div>
          </div>
          ...
          <div class = "row mb-2">
              ...
              <div class="col-8">
                <input type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation/ Position held" required>
              </div>
          </div>
          ...
          <div class = "row mb-2">
              ...
              <div class="col-8">
                <input type="email" name="emailadr" id="emailadr" class="form-control" placeholder="name@domain.com" required>
              </div>
          </div>
              ...
              <div class="col-12">
                <div class="input-group mb-3">
                  <div class="input-group-text">
                    <input required class="form-check-input mt-0" id="agree" name="agree" type="checkbox" aria-label="Checkbox for following text input">
                  </div>
